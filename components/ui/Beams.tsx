...
function extendMaterial(
  BaseMaterial: new (cfg: Record<string, unknown>) => THREE.MeshStandardMaterial,
  cfg: {
    header: string;
    vertexHeader?: string;
...
export default function Beams({
  ...
  const beamMaterial = useMemo(
    () =>
      extendMaterial(THREE.MeshStandardMaterial as unknown as new (cfg: Record<string, unknown>) => THREE.MeshStandardMaterial, {
        header: `
varying vec3 vEye;
  ...
  return (
    <CanvasWrapper>
      <group rotation={[0, 0, degToRad(rotation)]}>
        <PlaneNoise material={beamMaterial} width={beamWidth} count={beamNumber} height={beamHeight} />
