...
export const projects: Project[] = [
  ...
  },
  {
    ...
    year: "2026",
    rotatingTexts: ["Personal Expense Tracker", "Progressive App", "Designing by Prompt", "Claude Code"],
    description: "An ongoing experiment in designing by prompt: a design system written for machines, tested on Minti, a personal spending tracker.",
